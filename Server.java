...
//					System.out.println("bound? " + serverSocket.isBound() + "closed? " + serverSocket.isClosed());
//				}
				try {
					serverSocket = new ServerSocket(6789);
					serverSocket.setSoTimeout(10000);
					hulk = new Peer(SHARED_FILE_PATH, "");
...
//				System.out.println("bound? " + serverSocket.isBound() + "closed? " + serverSocket.isClosed());
				...
				try {
					...
					hulk = new Peer(SHARED_FILE_PATH, peerIP);
					hulk.sendIP();
					hulk.download();
				} catch (Exception e) {
	...
	// }
	//
	// static Stack<String> getMissingFiles(List<String> myFilesList,
	// List<String> peerFileList) {
