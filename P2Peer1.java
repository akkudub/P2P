...
public class P2Peer1 {
	final static int APPLICATION_PORT = 6969;
	final static int CONNECTION_TIMEOUT = 15000;
	final static int KB_TIMEOUT = 15000;
	
	final static String SHARED_FILE_PATH = P2Peer1.class.getProtectionDomain().getCodeSource().getLocation().getPath()
			+ "../src" + File.separator + "P2Peer1_Shared_Files" + File.separator;
